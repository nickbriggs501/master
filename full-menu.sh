...
do
  ...
  then
    ...
    do
      ...
      echo $R"4)$G kali"
      echo $R"5)$G P4wnp1"
      echo $R"6)$G P4wnP1 aloa"
      echo $R"7)$G Raspbian"
      echo $R"8)$G Pitail"
      echo $R"9)$G P4wnP1 usb"
      echo " "
      echo $R"x)$G exit"
      echo " "
      ...
      then
        ...
        echo $G" "
        read -p $G"user name: $R" user_n
        read -p $G"ip address: $R" user_add
        ssh $user_n@$user_add
      fi
      if [ $user_c == 2 ]
      then
        ...
        read -p $G"user name: $R" user_n
        read -p $G"ip address: $R" user_add
        read -p $G"file/s: $R" user_f
        read -p $G"destination: $R" user_d
